...
from users.views import RegisterView, ProfileView, activate_account, ActivationOk, ActivationFailed, toggle_activity, \
    UserListView
...
urlpatterns = [
    ...
    path('users/activity/<int:pk>/', toggle_activity, name='toggle_activity')
]
